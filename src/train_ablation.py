...
def main():
    print("\n" + "=" * 70)
    print("🔬 Ablation Study: Without Positional Encoding")
    print("=" * 70)

    # Load config
    config_path = 'configs/ablation_no_pe.yaml'
    ...
    # Create model WITHOUT positional encoding
    print("\n🤖 Creating model WITHOUT positional encoding...")
    ...
    print("\n" + "=" * 70)
    print("🎯 Training Start (No Positional Encoding)")
    print("=" * 70)
    ...
    with open(result_path, 'w', encoding='utf-8') as f:
        f.write("=" * 70 + "\n")
        f.write("Ablation Study: WITHOUT Positional Encoding\n")
